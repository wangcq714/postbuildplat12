...
class Register(object):
    ...
    def key_gen(self):
        machinecode = input('please input your machine code: ')
        machinecode_b = bytes(machinecode, encoding='utf-8')
        regist_code = self.Encrypted(machinecode_b)
        regist_code = str(regist_code, encoding = "utf-8")
        with open("regist_code.txt", 'w') as f:
            f.write(regist_code)

        print('注册码：', regist_code)
